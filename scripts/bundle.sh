...
# Same relative path as in the repo, so the README's docs/ link resolves inside an extracted tarball too.
mkdir -p "$BUNDLE_ROOT/docs"
cp "$REPO_ROOT/docs/exposing.md" "$BUNDLE_ROOT/docs/exposing.md"
